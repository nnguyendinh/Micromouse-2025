...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA6     ------> ADC1_IN6
    */
    HAL_GPIO_DeInit(GPIOC, ForwardRightReceiver_Pin|RightReceiver_Pin);

    HAL_GPIO_DeInit(GPIOA, LeftReceiver_Pin|ForwardLeftReceiver_Pin);
...
void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef* htim_encoder)
{
  ...
  /* USER CODE END TIM3_MspDeInit 0 */
    ...
    PB5     ------> TIM3_CH2
    */
    HAL_GPIO_DeInit(GPIOB, RightEncoderCh1_Pin|RightEncoderCh2_Pin);
  ...
  /* USER CODE END TIM8_MspDeInit 0 */
    ...
    PC7     ------> TIM8_CH2
    */
    HAL_GPIO_DeInit(GPIOC, LeftEncoderCh1_Pin|LeftEncoderCh2_Pin);
